...
<div class="row">
    ...
    <div>
        ...
        <select name="idVenta" class="form-control">
            ...
            <option value="{{$venta->idVenta}}" @isset($stock) {{ ($stock->idVenta ==$venta->idVenta)?'selected':''}}
                @endisset>
                {{ $venta->idVenta }}
            </option>
            @endforeach
        ...
        <select name="idStock" class="form-control">
            ...
            <option value="{{$stock->idStock}}" @isset($stock) {{ ($stock->idStock ==$stock->idStock)?'selected':''}}
                @endisset>
                {{ $stock->idStock }}
            </option>
            @endforeach
